// file: web/src/app/(public)/shop/[shopId]/recommendations/RecommendationsClient.tsx
"use client"
...
export default function RecommendationsClient(props: { shopId: string }) {
  ...
  const type = (searchParams.get("type") as AlcoholType) || "sake"
